...
class Solution {
  public:
    int numberOfSpecialChars(string word) {
        int n = sz(word);
        vi lowerCase(26, -1), upperCase(26, -1);
...
int main() {
    ...
    Solution obj;
    auto res = obj.numberOfSpecialChars("aaAbcBC");
    print(res);
    res = obj.numberOfSpecialChars("abc");
    print(res);
    res = obj.numberOfSpecialChars("AbBCab");
    print(res);
    return 0;
}
