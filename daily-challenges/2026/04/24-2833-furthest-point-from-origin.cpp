...
int main() {
    ...
    Solution obj;
    auto res = obj.furthestDistanceFromOrigin("L_RL__R");
    print(res);
    res = obj.furthestDistanceFromOrigin("_R__LL_");
    print(res);
    res = obj.furthestDistanceFromOrigin("_______");
    print(res);
    return 0;
}
