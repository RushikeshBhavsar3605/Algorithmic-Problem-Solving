  ...
  public:
    bool wordPattern(string pattern, string s) {
        ...
        loop(i, 0, sz(pattern)) {
            ...
            if (sC.count(word) && sC[word] != letter)
                return false;

            if (cS.count(letter) && cS[letter] != word)
                return false;
...
int main() {
    ...
    Solution obj;
    auto res = obj.wordPattern("abba", "dog cat cat dog");
    print(res);
    res = obj.wordPattern("abba", "dog cat cat fish");
    print(res);
    res = obj.wordPattern("aaaa", "dog cat cat dog");
    print(res);
    return 0;
}
