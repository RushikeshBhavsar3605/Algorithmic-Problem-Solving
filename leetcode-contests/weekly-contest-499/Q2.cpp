...
class Solution {
  public:
    string sortVowels(string s) {
        ...
        vector<pair<int, pair<int, char>>> f;
        for (const auto &[key, value] : mp) {
            f.pb({value, {first[key], key}});
        }
...
int main() {
    ...
    Solution obj;
    auto res = obj.sortVowels("leetcode");
    print(res);
    res = obj.sortVowels("aeiaaioooa");
    print(res);
    res = obj.sortVowels("baeiou");
    print(res);
    return 0;
}
