...
/* Approach (Number Theory + Sieve): */
class Solution {
  private:
    int INF = 1e5;

    vi compute(vi &nums, vi &mp) {
        vi freq(INF + 1, INT_MAX);
...
int main() {
    ...
    Solution obj;
    vi v = {3, 6, 2};
    auto res = obj.minArraySum(v);
    print(res);
    v = {4, 2, 8, 3};
    res = obj.minArraySum(v);
    print(res);
    v = {7, 5, 9};
    res = obj.minArraySum(v);
    print(res);
